...
const trackNewline = new index.ContextTracker({
  start: false,
  shift(context, term) {
...
const insertSemicolon = new index.ExternalTokenizer((input, stack) => {
  let {next} = input;
  if ((next == braceR || next == -1 || stack.context) && stack.canShift(insertSemi))
    input.acceptToken(insertSemi);
}, {contextual: true, fallback: true});

const noSemicolon = new index.ExternalTokenizer((input, stack) => {
...
const incdecToken = new index.ExternalTokenizer((input, stack) => {
  let {next} = input;
...
const template = new index.ExternalTokenizer(input => {
...
const parser = index.LRParser.deserialize({
  ...
  nodeProps: [
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.group, -26,7,14,16,54,176,180,183,184,186,189,192,203,205,211,213,215,217,220,226,230,232,234,236,238,240,241,"Statement",-30,11,13,23,26,27,38,39,40,41,43,48,56,64,70,71,84,85,94,95,111,114,116,117,118,119,121,122,140,141,143,"Expression",-22,22,24,28,29,31,144,146,148,149,151,152,153,155,156,157,159,160,161,170,172,174,175,"Type",-2,75,79,"ClassItem"],
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.closedBy, 37,"]",47,"}",62,")",124,"JSXSelfCloseEndTag JSXEndTag",138,"JSXEndTag"],
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.openedBy, 42,"[",46,"{",61,"(",123,"JSXStartTag",133,"JSXStartTag JSXStartCloseTag"]
  ],
  skippedNodes: [0,4,5],
  repeatNodeCount: 28,
...
*/
const snippets = [
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("function ${name}(${params}) {\n\t${}\n}", {
        label: "function",
        detail: "definition",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
        label: "for",
        detail: "loop",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("for (let ${name} of ${collection}) {\n\t${}\n}", {
        label: "for",
        detail: "of loop",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("try {\n\t${}\n} catch (${error}) {\n\t${}\n}", {
        label: "try",
        detail: "block",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("class ${name} {\n\tconstructor(${params}) {\n\t\t${}\n\t}\n}", {
        label: "class",
        detail: "definition",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("import {${names}} from \"${module}\"\n${}", {
        label: "import",
        detail: "named",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.snippetCompletion("import ${name} from \"${module}\"\n${}", {
        label: "import",
        detail: "default",
        type: "keyword"
    })
...
*/
const javascriptLanguage = /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LRLanguage.define({
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.indentNodeProp.add({
                IfStatement: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.continuedIndent({ except: /^\s*({|else\b)/ }),
                TryStatement: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.continuedIndent({ except: /^\s*({|catch|finally)\b/ }),
                LabeledStatement: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.flatIndent,
                SwitchBody: context => {
                    let after = context.textAfter, closed = /^\s*\}/.test(after), isCase = /^\s*(case|default)\b/.test(after);
                    return context.baseIndent + (closed ? 0 : isCase ? 1 : 2) * context.unit;
                },
                Block: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.delimitedIndent({ closing: "}" }),
                ArrowFunction: cx => cx.baseIndent + cx.unit,
                "TemplateString BlockComment": () => -1,
                "Statement Property": /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.continuedIndent({ except: /^{/ }),
                JSXElement(context) {
            ...
            /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.foldNodeProp.add({
                "Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.foldInside,
                BlockComment(tree) { return { from: tree.from + 2, to: tree.to - 2 }; }
            }),
            /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.styleTags({
                "get set async static": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.modifier,
                "for while do if else switch try catch finally return throw break continue default case": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.controlKeyword,
                "in of await yield void typeof delete instanceof": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.operatorKeyword,
                "export import let var const function class extends": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definitionKeyword,
                "with debugger from as new": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.keyword,
                TemplateString: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.special(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.string),
                Super: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.atom,
                BooleanLiteral: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.bool,
                this: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.self,
                null: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.null,
                Star: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.modifier,
                VariableName: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.variableName,
                "CallExpression/VariableName": /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.function(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.variableName),
                VariableDefinition: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definition(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.variableName),
                Label: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.labelName,
                PropertyName: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.propertyName,
                "CallExpression/MemberExpression/PropertyName": /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.function(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.propertyName),
                "FunctionDeclaration/VariableDefinition": /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.function(/*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definition(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.variableName)),
                "ClassDeclaration/VariableDefinition": /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definition(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.className),
                PropertyNameDefinition: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definition(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.propertyName),
                UpdateOp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.updateOperator,
                LineComment: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.lineComment,
                BlockComment: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.blockComment,
                ...
                ArithOp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.arithmeticOperator,
                LogicOp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.logicOperator,
                BitOp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.bitwiseOperator,
                CompareOp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.compareOperator,
                RegExp: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.regexp,
                Equals: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definitionOperator,
                "Arrow : Spread": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.punctuation,
                ...
                ".": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.derefOperator,
                ", ;": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.separator,
                TypeName: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.typeName,
                TypeDefinition: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definition(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.typeName),
                "type enum interface implements namespace module declare": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.definitionKeyword,
                "abstract global privacy readonly": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.modifier,
                "is keyof unique infer": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.operatorKeyword,
                JSXAttributeValue: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.string,
                JSXText: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.content,
                "JSXStartTag JSXStartCloseTag JSXSelfCloseEndTag JSXEndTag": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.angleBracket,
                "JSXIdentifier JSXNameSpacedName": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.tagName,
                "JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName": stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.propertyName
            })
        ]
    }),
    languageData: {
...
function javascript(config = {}) {
    ...
    return new stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LanguageSupport(lang, javascriptLanguage.data.of({
        autocomplete: stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.ifNotIn(["LineComment", "BlockComment", "String"], stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.completeFromList(snippets))
    }));
}
