...
const index$1 = require('./index-77e1ad50.js');
const _commonjsHelpers = require('./_commonjsHelpers-1fbbf0eb.js');
const schema = require('./schema-fcf985c7.js');
const _function = require('./function-d841d074.js');
const toastController = require('./toastController-2fd1bc91.js');
const index = require('./index-80393b6d.js');
...
const jobFetch = index.factory().options({ credentials: 'include' });
...
const SessionStatus = ({ session, job }, children) => (index$1.h("span", { class: {
    executableDocumentStatus: true,
    danger: isFailure(session),
    success: isSuccess(session),
  } }, _function._function.pipe(session, fold(() => '', () => (index$1.h("span", null,
  index$1.h("stencila-icon", { icon: "loader-2" }),
  index$1.h("span", null, jobStatusString(job)))), (refreshingErroredJob) => (index$1.h("span", null,
  index$1.h("stencila-icon", { icon: "loader-2" }),
  index$1.h("span", null, jobErrorMessage(refreshingErroredJob)))), (refreshingSession) => (index$1.h("span", null, isEmpty(children) ? ([
  index$1.h("stencila-icon", { icon: "loader-2" }),
  refreshingSession.status,
]) : (index$1.h("span", null, children)))), (err) => (index$1.h("span", null,
  index$1.h("stencila-icon", { icon: "error-warning" }),
  index$1.h("span", null, jobErrorMessage(err)))), () => (index$1.h("stencila-tooltip", { text: "Compute session is active" },
  index$1.h("stencila-icon", { icon: "pulse" }),
  isEmpty(children) ? null : index$1.h("span", null, children)))))));
...
const StencilaExecutableDocumentToolbar = class {
  constructor(hostRef) {
    ...
    this.executionProgress = () => (index$1.h("stencila-tooltip", { text: "Jump to location", onClick: this.goToActiveNode }, index$1.h("stencila-icon", { icon: "focus-3" }), index$1.h("span", null, this.statusMessage)));
  }
  componentWillLoad() {
  ...
  render() {
    return (index$1.h(index$1.Host, { position: this.position }, index$1.h("stencila-toolbar", null, index$1.h("span", { slot: "start" }, index$1.h("stencila-button", { color: "stock", icon: "play", size: "small", onClick: this.runAll, disabled: this.codeCount <= 0, tooltip: this.codeCount <= 0
      ...
      ? 'Running'
      : ['Run', index$1.h("span", { class: "hidden-sm" }, " Document")])), index$1.h("span", { slot: "middle" }, index$1.h(SessionStatus, { job: this.job, session: this.session }, isRefresh(this.session) && this.executionProgress())), this.sourceUrl !== undefined && (index$1.h("span", { slot: "end" }, index$1.h("stencila-button", { color: "stock", href: this.sourceUrl, target: "_blank", rel: "nofollow noopener", icon: "external-link", size: "small", dataEl: "Toolbar/Project Source" }, "Source"))))));
  }
};
