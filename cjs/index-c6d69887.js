...
const parser = index.LRParser.deserialize({
  ...
  nodeProps: [
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.closedBy, 1,"SelfCloseEndTag EndTag",12,"CloseTag MissingCloseTag"],
    [stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.NodeProp.openedBy, 11,"StartTag StartCloseTag",23,"OpenTag",24,"StartTag"]
  ],
  skippedNodes: [0],
  repeatNodeCount: 9,
...
function findLocation(state, pos) {
    var _a;
    let at = stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.syntaxTree(state).resolveInner(pos, -1), inTag = null;
...
*/
const xmlLanguage = /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.LRLanguage.define({
    parser: /*@__PURE__*/parser.configure({
        props: [
            ...
            /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.styleTags({
                ...
                Cdata: /*@__PURE__*/stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.special(stencilaActionMenu_stencilaEditor_stencilaNodeList_entry.tags.string)
            })
        ]
    }),
    languageData: {
