...
export class Editor {
  constructor() {
     ...
     */
    this.activeLanguage = (_b = (_a = this.languageCapabilities.R) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : '';
  ...
  render() {
    return (h(Host, null,
      h("div", { class: cssClasses.container },
        ...
        h("menu", null,
          h(LanguagePicker, { activeLanguage: this.activeLanguage, onSetLanguage: this.onSelectLanguage, languageCapabilities: this.languageCapabilities, setRef: this.setLanguagePickerRef })))));
  }
