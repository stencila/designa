...
import { f as sqrt, c as cos, s as sin, t as tau, p as pi, Z as Timer, a5 as dispatch, a6 as timer, E as interpolateNumber, F as color, G as interpolateRgb, H as interpolateString, O as interpolateTransformSvg, N as interpolateTransformCss, Y as now, P as interpolateZoom, T as Symbol$1, a7 as symbolCircle, _ as forceSimulation, a2 as forceLink, a1 as forceManyBody, a0 as forceCollide, a3 as forceX, a4 as forceY, $ as forceCenter, l as line, W as curveBasisClosed } from './y-3c98f269.js';
...
const getResourceSymbol = (resource, size = 512) => {
  switch (resource.type) {
    case 'Node': {
      return Symbol$1(symbolTriangle, size);
    }
    case 'Symbol': {
      return Symbol$1(symbolDiamond, size);
    }
    case 'Source': {
      return Symbol$1(symbolStar, size);
    }
    case 'File': {
      return Symbol$1(symbolWye, size);
    }
    case 'Url': {
      return Symbol$1(symbolSquare, size);
    }
    case 'Module':
    default: {
      return Symbol$1(symbolCircle, size);
    }
  }
};
...
const ProjectGraph = class {
  ...
  render() {
    return (h(Host, null, h("div", { ref: (el) => (this.el = el), class: "projectGraph" })));
  }
