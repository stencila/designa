import { r as registerInstance, h, c as getElement } from './index-2305c23c.js';
...
const ActionMenu = class {
  ...
  render() {
    if (this.el.children.length <= 0)
      return null;
    return (h("nav", null, h("span", { class: "persistentActions" }, h("slot", { name: slots.persistentActions })), h("span", { class: {
        secondaryActions: true,
        hidden: !this.hasSecondaryActions,
      } }, h("stencila-button", { onClick: this.toggleActionMenu, icon: "more", color: "key", minimal: true, size: "xsmall", iconOnly: true, ariaLabel: "Toggle Action Menu" }), h("span", { class: {
        actionContainer: true,
        isAnimating: this.isAnimating,
        isCollapsed: this.isCollapsed,
      }, ref: (el) => (this.actionContainerRef = el), style: { '--max-width': this.width } }, h("slot", null)))));
  }
...
export { ActionMenu as stencila_action_menu };
