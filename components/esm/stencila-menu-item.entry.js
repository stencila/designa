import { r as registerInstance, h, F as Fragment, e as Host, c as getElement } from './index-2305c23c.js';
...
const MenuItem = class {
  ...
  render() {
    ...
    return (h(Host, Object.assign({}, ariaAttrs, { size: this.size }), ((_a = this.el) === null || _a === void 0 ? void 0 : _a.slot) === 'toggle' ? (h(Fragment, null, this.icon !== undefined && (h("stencila-icon", { icon: this.icon })), h("slot", null))) : (h("li", null, this.icon !== undefined && (h("stencila-icon", { icon: this.icon })), h("slot", null)))));
  }
...
//# sourceMappingURL=stencila-menu-item.entry.js.map