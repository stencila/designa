import { h, r as registerInstance, f as createEvent, e as Host, c as getElement } from './index-2305c23c.js';
import { g as getSlotByName } from './slotSelectors-df70e421.js';
import { a as lookupFormat, f as fileFormatMap } from './languageUtils-2c49a4c4.js';
...
const Editor = class {
  constructor(hostRef) {
    ...
    this.getLang = async (language) => {
      switch (lookupFormat(language).name.toLowerCase()) {
        case 'bash':
        case 'zsh': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { shell } = await import('./shell-f1520e9d.js');
          return StreamLanguage.define(shell);
        }
        case 'latex': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { stexMath } = await import('./stex-5289b311.js');
          return StreamLanguage.define(stexMath);
        }
        case 'toml': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { toml } = await import('./toml-9561606b.js');
          return StreamLanguage.define(toml);
        }
        case 'yaml': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { yaml } = await import('./yaml-c86188d3.js');
          return StreamLanguage.define(yaml);
        }
        case 'dockerfile': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { dockerFile } = await import('./dockerfile-fbfef70c.js');
          return StreamLanguage.define(dockerFile);
        }
        case 'html': {
          const { html } = await import('./index-fa83f062.js');
          return html();
        }
        case 'javascript': {
          const { javascript } = await import('./index-12d58319.js');
          return javascript();
        }
        case 'typescript': {
          const { javascript } = await import('./index-12d58319.js');
        ...
        case 'json': {
          const { json } = await import('./index-cec7f230.js');
          return json();
        }
        case 'xml': {
          const { xml } = await import('./index-20290304.js');
          return xml();
        }
        case 'calc':
        case 'python': {
          const { python } = await import('./index-d887d8aa.js');
          return python();
        }
        case 'r': {
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { r } = await import('./r-6f6c9fd0.js');
          return StreamLanguage.define(r);
        }
        case 'rmd': {
          const { markdown } = await import('./index-74ae9671.js');
          const { StreamLanguage } = await import('./index-3b0b5738.js');
          const { r } = await import('./r-6f6c9fd0.js');
        ...
        case 'sql': {
          const { sql } = await import('./index-29265033.js');
          return sql();
        }
      }
    };
  ...
  render() {
    return (h(Host, null, h("div", { class: cssClasses.container }, h("div", {
      // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
      class: cssClasses.editor, onKeyDown: this.stopEventPropagation, onClick: this.focus
    }, h("div", { class: "hidden", ref: (el) => (this.textSlot = el) }, h("slot", { name: slots.text })), h("div", { ref: (el) => (this.errorsSlot = el) }, h("slot", { name: slots.errors })), h("div", { id: cssIds.editorTarget })), h("menu", null, h(LanguagePicker, { activeLanguage: this.activeLanguage, disabled: this.readOnly, onSetLanguage: this.onSelectLanguage, languageCapabilities: this.languageCapabilities, executableLanguages: this.executableLanguages, setRef: this.setLanguagePickerRef })))));
  }
