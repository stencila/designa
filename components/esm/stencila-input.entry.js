...
const Input = class {
  ...
  render() {
    ...
    return (h(Host, { class: { inline: this.inline } }, this.iconStart !== undefined && (h("stencila-icon", { icon: this.iconStart })), h("input", Object.assign({}, _type, _label, {
...
//# sourceMappingURL=stencila-input.entry.js.map