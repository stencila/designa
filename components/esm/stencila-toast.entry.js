...
import { T as ToastTypes } from './toastController-5becfc9e.js';
...
const StencilaToast = class {
  ...
  render() {
    return (h(Host, { type: this.type, position: this.position, dismissable: this.dismissable === true || this.duration === 0, onMouseEnter: this.pauseAutoDismiss, onMouseLeave: this.autoDismiss }, h("div", { class: "toastAccent" }, h("stencila-icon", { icon: this.getIconByType(), iconStyle: "fill" })), h("div", { class: "content" }, h("slot", { name: "title" }), h("slot", null), h("slot", { name: "actions" })), (this.dismissable === true || this.duration === 0) && (h("stencila-button", { color: "neutral", iconOnly: true, icon: "close", minimal: true, size: "small", onClick: this.dismiss, class: "closeButton" }))));
  }
...
export { StencilaToast as stencila_toast };

//# sourceMappingURL=stencila-toast.entry.js.map