...
const OutputsList = class {
  ...
  render() {
    return (h(Host, null, h("slot", null), h("em", { class: { hidden: !this.isEmpty, emptyContentMessage: true } }, this.emptyOutputMessage)));
  }
...
export { OutputsList as stencila_node_list };

//# sourceMappingURL=stencila-node-list.entry.js.map