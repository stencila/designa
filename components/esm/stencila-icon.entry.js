import { r as registerInstance, i as getAssetPath, h, e as Host } from './index-2305c23c.js';
  ...
  render() {
    const iconName = isSuffixedIconName(this.icon)
      ...
      : isUnsuffixedIconName(this.icon)
        ? `#ri-${this.icon}`
        : this.icon;
    return (h(Host, { icon: this.icon, "aria-hidden": "true" }, h("svg", { style: {
...
//# sourceMappingURL=stencila-icon.entry.js.map