...
const CodeErrorComponent = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "overview", onClick: this.toggleStackTraceIsOpen }, h("slot", { name: "type" }), h("slot", { name: "message" }), h("stencila-icon", { icon: "stack", class: `stacktrace-icon ${this.hasStackTrace ? '' : 'hide'}` })), h("stencila-details", { open: this.stackTraceIsOpen, class: `stacktrace-details ${this.hasStackTrace ? '' : 'hide'}` }, h("slot", { name: "stacktrace" }))));
  }
...
export { CodeErrorComponent as stencila_code_error };

//# sourceMappingURL=stencila-code-error.entry.js.map