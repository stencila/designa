...
const startTag = new index.ExternalTokenizer((input, stack) => {
...
const parser = index.LRParser.deserialize({
  ...
  nodeProps: [
    [stencilaEditor_entry.NodeProp.closedBy, 1,"SelfCloseEndTag EndTag",12,"CloseTag MissingCloseTag"],
    [stencilaEditor_entry.NodeProp.openedBy, 11,"StartTag StartCloseTag",23,"OpenTag",24,"StartTag"]
  ],
  skippedNodes: [0],
  repeatNodeCount: 9,
...
function findLocation(state, pos) {
    var _a;
    let at = stencilaEditor_entry.syntaxTree(state).resolveInner(pos, -1), inTag = null;
...
*/
const xmlLanguage = /*@__PURE__*/stencilaEditor_entry.LRLanguage.define({
    parser: /*@__PURE__*/parser.configure({
        props: [
            ...
            /*@__PURE__*/stencilaEditor_entry.styleTags({
                Text: stencilaEditor_entry.tags.content,
                "StartTag StartCloseTag EndTag SelfCloseEndTag": stencilaEditor_entry.tags.angleBracket,
                ...
                AttributeValue: stencilaEditor_entry.tags.attributeValue,
                ...
                Cdata: /*@__PURE__*/stencilaEditor_entry.tags.special(stencilaEditor_entry.tags.string)
            })
        ]
    }),
    languageData: {
...
*/
function xml(conf = {}) {
    return new stencilaEditor_entry.LanguageSupport(xmlLanguage, xmlLanguage.data.of({
...
//# sourceMappingURL=index-8600f86b.js.map