...
const StencilaDocumentToolbar = class {
  constructor(hostRef) {
    ...
    this.kernelRestart = index.createEvent(this, "stencila-kernel-restart", 7);
  ...
  render() {
    return (index.h(index.Host, { position: this.position }, index.h("stencila-toolbar", null, index.h("span", { slot: "start" }, index.h("stencila-button", { onKeyDown: this.onKeyPress, color: "stock", icon: this.altIsPressed
        ? 'restart'
        : codeUtils.isPending(this.executeStatus)
          ? 'stop'
      ...
      : codeUtils.isPending(this.executeStatus)
        ? 'Cancel all'
        : 'Run all')), this.sourceUrl !== undefined && (index.h("span", { slot: "end" }, index.h("stencila-button", { color: "stock", href: this.sourceUrl, target: "_blank", rel: "nofollow noopener", icon: "external-link", size: "small", dataEl: "Toolbar/Project Source" }, "Source"))))));
  }
};
...
exports.stencila_document_toolbar = StencilaDocumentToolbar;

//# sourceMappingURL=stencila-document-toolbar.cjs.entry.js.map