...
const parser = index.LRParser.deserialize({
  ...
  nodeProps: [
    [stencilaEditor_entry.NodeProp.closedBy, 3,"InterpolationEnd",40,"]",51,"}",66,")",132,"JSXSelfCloseEndTag JSXEndTag",146,"JSXEndTag"],
    [stencilaEditor_entry.NodeProp.group, -26,8,15,17,58,184,188,191,192,194,197,200,211,213,219,221,223,225,228,234,238,240,242,244,246,248,249,"Statement",-30,12,13,24,27,28,41,43,44,45,47,52,60,68,74,75,91,92,101,103,119,122,124,125,126,127,129,130,148,149,151,"Expression",-22,23,25,29,32,34,152,154,156,157,159,160,161,163,164,165,167,168,169,178,180,182,183,"Type",-3,79,85,90,"ClassItem"],
    [stencilaEditor_entry.NodeProp.openedBy, 30,"InterpolationStart",46,"[",50,"{",65,"(",131,"JSXStartTag",141,"JSXStartTag JSXStartCloseTag"]
  ],
  skippedNodes: [0,5,6],
  repeatNodeCount: 28,
...
*/
const snippets = [
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("function ${name}(${params}) {\n\t${}\n}", {
        label: "function",
        detail: "definition",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
        label: "for",
        detail: "loop",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("for (let ${name} of ${collection}) {\n\t${}\n}", {
        label: "for",
        detail: "of loop",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("try {\n\t${}\n} catch (${error}) {\n\t${}\n}", {
        label: "try",
        detail: "block",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("class ${name} {\n\tconstructor(${params}) {\n\t\t${}\n\t}\n}", {
        label: "class",
        detail: "definition",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("import {${names}} from \"${module}\"\n${}", {
        label: "import",
        detail: "named",
        type: "keyword"
    }),
    /*@__PURE__*/stencilaEditor_entry.snippetCompletion("import ${name} from \"${module}\"\n${}", {
        label: "import",
        detail: "default",
        type: "keyword"
    })
...
*/
const javascriptLanguage = /*@__PURE__*/stencilaEditor_entry.LRLanguage.define({
    parser: /*@__PURE__*/parser.configure({
        props: [
            /*@__PURE__*/stencilaEditor_entry.indentNodeProp.add({
                IfStatement: /*@__PURE__*/stencilaEditor_entry.continuedIndent({ except: /^\s*({|else\b)/ }),
                TryStatement: /*@__PURE__*/stencilaEditor_entry.continuedIndent({ except: /^\s*({|catch\b|finally\b)/ }),
                LabeledStatement: stencilaEditor_entry.flatIndent,
                SwitchBody: context => {
                    let after = context.textAfter, closed = /^\s*\}/.test(after), isCase = /^\s*(case|default)\b/.test(after);
                    return context.baseIndent + (closed ? 0 : isCase ? 1 : 2) * context.unit;
                },
                Block: /*@__PURE__*/stencilaEditor_entry.delimitedIndent({ closing: "}" }),
                ArrowFunction: cx => cx.baseIndent + cx.unit,
                "TemplateString BlockComment": () => -1,
                "Statement Property": /*@__PURE__*/stencilaEditor_entry.continuedIndent({ except: /^{/ }),
                JSXElement(context) {
            ...
            /*@__PURE__*/stencilaEditor_entry.foldNodeProp.add({
                "Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression": stencilaEditor_entry.foldInside,
                BlockComment(tree) { return { from: tree.from + 2, to: tree.to - 2 }; }
            }),
            /*@__PURE__*/stencilaEditor_entry.styleTags({
                "get set async static": stencilaEditor_entry.tags.modifier,
                "for while do if else switch try catch finally return throw break continue default case": stencilaEditor_entry.tags.controlKeyword,
                "in of await yield void typeof delete instanceof": stencilaEditor_entry.tags.operatorKeyword,
                "let var const function class extends": stencilaEditor_entry.tags.definitionKeyword,
                "import export from": stencilaEditor_entry.tags.moduleKeyword,
                "with debugger as new": stencilaEditor_entry.tags.keyword,
                TemplateString: /*@__PURE__*/stencilaEditor_entry.tags.special(stencilaEditor_entry.tags.string),
                Super: stencilaEditor_entry.tags.atom,
                BooleanLiteral: stencilaEditor_entry.tags.bool,
                this: stencilaEditor_entry.tags.self,
                null: stencilaEditor_entry.tags.null,
                Star: stencilaEditor_entry.tags.modifier,
                VariableName: stencilaEditor_entry.tags.variableName,
                "CallExpression/VariableName TaggedTemplateExpression/VariableName": /*@__PURE__*/stencilaEditor_entry.tags.function(stencilaEditor_entry.tags.variableName),
                VariableDefinition: /*@__PURE__*/stencilaEditor_entry.tags.definition(stencilaEditor_entry.tags.variableName),
                Label: stencilaEditor_entry.tags.labelName,
                PropertyName: stencilaEditor_entry.tags.propertyName,
                PrivatePropertyName: /*@__PURE__*/stencilaEditor_entry.tags.special(stencilaEditor_entry.tags.propertyName),
                "CallExpression/MemberExpression/PropertyName": /*@__PURE__*/stencilaEditor_entry.tags.function(stencilaEditor_entry.tags.propertyName),
                "FunctionDeclaration/VariableDefinition": /*@__PURE__*/stencilaEditor_entry.tags.function(/*@__PURE__*/stencilaEditor_entry.tags.definition(stencilaEditor_entry.tags.variableName)),
                "ClassDeclaration/VariableDefinition": /*@__PURE__*/stencilaEditor_entry.tags.definition(stencilaEditor_entry.tags.className),
                PropertyDefinition: /*@__PURE__*/stencilaEditor_entry.tags.definition(stencilaEditor_entry.tags.propertyName),
                PrivatePropertyDefinition: /*@__PURE__*/stencilaEditor_entry.tags.definition(/*@__PURE__*/stencilaEditor_entry.tags.special(stencilaEditor_entry.tags.propertyName)),
                UpdateOp: stencilaEditor_entry.tags.updateOperator,
                ...
                ArithOp: stencilaEditor_entry.tags.arithmeticOperator,
                LogicOp: stencilaEditor_entry.tags.logicOperator,
                BitOp: stencilaEditor_entry.tags.bitwiseOperator,
                CompareOp: stencilaEditor_entry.tags.compareOperator,
                RegExp: stencilaEditor_entry.tags.regexp,
                Equals: stencilaEditor_entry.tags.definitionOperator,
                "Arrow : Spread": stencilaEditor_entry.tags.punctuation,
                "( )": stencilaEditor_entry.tags.paren,
                "[ ]": stencilaEditor_entry.tags.squareBracket,
                "{ }": stencilaEditor_entry.tags.brace,
                "InterpolationStart InterpolationEnd": /*@__PURE__*/stencilaEditor_entry.tags.special(stencilaEditor_entry.tags.brace),
                ".": stencilaEditor_entry.tags.derefOperator,
                ", ;": stencilaEditor_entry.tags.separator,
                TypeName: stencilaEditor_entry.tags.typeName,
                TypeDefinition: /*@__PURE__*/stencilaEditor_entry.tags.definition(stencilaEditor_entry.tags.typeName),
                "type enum interface implements namespace module declare": stencilaEditor_entry.tags.definitionKeyword,
                "abstract global Privacy readonly override": stencilaEditor_entry.tags.modifier,
                "is keyof unique infer": stencilaEditor_entry.tags.operatorKeyword,
                JSXAttributeValue: stencilaEditor_entry.tags.attributeValue,
                JSXText: stencilaEditor_entry.tags.content,
                "JSXStartTag JSXStartCloseTag JSXSelfCloseEndTag JSXEndTag": stencilaEditor_entry.tags.angleBracket,
                "JSXIdentifier JSXNameSpacedName": stencilaEditor_entry.tags.tagName,
                "JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName": stencilaEditor_entry.tags.attributeName
            })
        ]
    }),
    languageData: {
...
function javascript(config = {}) {
    ...
    return new stencilaEditor_entry.LanguageSupport(lang, javascriptLanguage.data.of({
        autocomplete: stencilaEditor_entry.ifNotIn(["LineComment", "BlockComment", "String"], stencilaEditor_entry.completeFromList(snippets))
    }));
}
...
//# sourceMappingURL=index-eaf5be69.js.map