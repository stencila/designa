...
const CodeBlockComponent = class {
  ...
  async getContents() {
    ...
    if (this.editorRef) {
      ...
      return schema.u({ text, programmingLanguage: language });
    }
  ...
  render() {
    return (index.h(index.Host, null, index.h("figure", null, index.h("div", null, index.h("div", { class: {
        editorContainer: true,
      } }, index.h("stencila-editor", { activeLanguage: this.programmingLanguage, executableLanguages: this.executableLanguages, autofocus: this.autofocus, keymap: this.keymap, readOnly: this.readOnly, "onStencila-language-change": this.handleLanguageChange, foldGutter: this.foldGutter, lineNumbers: this.lineNumbers, lineWrapping: this.lineWrapping, ref: (el) => {
        this.editorRef = el;
      } }, index.h("slot", { name: CodeBlockComponent.slots.text }), index.h("slot", { name: CodeBlockComponent.slots.errors })))), index.h("slot", { name: CodeBlockComponent.slots.label }), index.h("slot", { name: CodeBlockComponent.slots.caption }))));
  }
};
...
exports.stencila_code_block = CodeBlockComponent;

//# sourceMappingURL=stencila-code-block.cjs.entry.js.map