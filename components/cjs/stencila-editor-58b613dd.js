...
const LanguagePicker = (props) => {
  ...
  return (index.h("label", { "aria-label": "Programming Language" },
    index.h("stencila-icon", { icon: "terminal" }),
    index.h("select", { onChange: props.onSetLanguage, ref: props.setRef, disabled: props.disabled },
      hasExecutableLanguages &&
        Object.values(props.executableLanguages).map((language) => (index.h("option", { value: language.name, selected: language.name === activeLanguageByAlias.name }, language.name))),
      index.h("option", { disabled: true }, "Not executable"),
      Object.values(filteredLanguages).map((language) => (index.h("option", { value: language.name, selected: language.name === activeLanguageByAlias.name }, language.name))))));
};

const updateErrors = StateEffect.define();
/**
...
const codeErrors = () => showPanel.of(errorPanel);
...
const Editor = class {
  constructor(hostRef) {
    ...
    this.getLang = async (language) => {
      switch (languageUtils.lookupFormat(language).name.toLowerCase()) {
        case 'bash':
        case 'zsh': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { shell } = await Promise.resolve().then(function () { return require('./shell-52bf5fd7.js'); });
          return StreamLanguage.define(shell);
        }
        case 'latex': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { stexMath } = await Promise.resolve().then(function () { return require('./stex-74c59fbc.js'); });
          return StreamLanguage.define(stexMath);
        }
        case 'toml': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { toml } = await Promise.resolve().then(function () { return require('./toml-1fcd29f2.js'); });
          return StreamLanguage.define(toml);
        }
        case 'yaml': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { yaml } = await Promise.resolve().then(function () { return require('./yaml-5b067a0d.js'); });
          return StreamLanguage.define(yaml);
        }
        case 'dockerfile': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { dockerFile } = await Promise.resolve().then(function () { return require('./dockerfile-ee3ac77a.js'); });
          return StreamLanguage.define(dockerFile);
        }
        case 'html': {
          const { html } = await Promise.resolve().then(function () { return require('./index-154be6e6.js'); });
          return html();
        }
        case 'javascript': {
          const { javascript } = await Promise.resolve().then(function () { return require('./index-eaf5be69.js'); });
          return javascript();
        }
        case 'typescript': {
          const { javascript } = await Promise.resolve().then(function () { return require('./index-eaf5be69.js'); });
        ...
        case 'json': {
          const { json } = await Promise.resolve().then(function () { return require('./index-960813ab.js'); });
          return json();
        }
        case 'xml': {
          const { xml } = await Promise.resolve().then(function () { return require('./index-8600f86b.js'); });
          return xml();
        }
        case 'calc':
        case 'python': {
          const { python } = await Promise.resolve().then(function () { return require('./index-ae534eb4.js'); });
          return python();
        }
        case 'r': {
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { r } = await Promise.resolve().then(function () { return require('./r-330dc062.js'); });
          return StreamLanguage.define(r);
        }
        case 'rmd': {
          const { markdown } = await Promise.resolve().then(function () { return require('./index-49f4450a.js'); });
          const { StreamLanguage } = await Promise.resolve().then(function () { return require('./index-6c9ed6ae.js'); });
          const { r } = await Promise.resolve().then(function () { return require('./r-330dc062.js'); });
        ...
        case 'sql': {
          const { sql } = await Promise.resolve().then(function () { return require('./index-359781e1.js'); });
          return sql();
        }
      }
    };
    ...
    this.onSelectLanguage = async (e) => {
      ...
      const language = languageUtils.lookupFormat(target.value);
    ...
    this.initCodeMirror = async () => {
      var _a, _b;
      const root = this.el;
      const slotEl = slotSelectors.getSlotByName(root)(slots.text)[0];
  ...
  getContents() {
    ...
    return Promise.resolve({
      ...
      language: languageUtils.lookupFormat((_d = (_c = this.languagePickerRef) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : this.activeLanguage).name.toLowerCase(),
    });
  }
  /**
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: cssClasses.container }, index.h("div", {
      // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
      class: cssClasses.editor, onKeyDown: this.stopEventPropagation, onClick: this.focus
    }, index.h("div", { class: "hidden", ref: (el) => (this.textSlot = el) }, index.h("slot", { name: slots.text })), index.h("div", { ref: (el) => (this.errorsSlot = el) }, index.h("slot", { name: slots.errors })), index.h("div", { id: cssIds.editorTarget })), index.h("menu", null, index.h(LanguagePicker, { activeLanguage: this.activeLanguage, disabled: this.readOnly, onSetLanguage: this.onSelectLanguage, languageCapabilities: this.languageCapabilities, executableLanguages: this.executableLanguages, setRef: this.setLanguagePickerRef })))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "contents": ["contentsChanged"],
    "readOnly": ["readOnlyChanged"],
    "activeLanguage": ["activeLanguageChanged"],
    "lineNumbers": ["onSetLineNumbers"],
    "lineWrapping": ["onSetLineWrapping"],
    "foldGutter": ["onSetfoldGutter"]
  }; }
};
Editor.style = {
...
exports.foldInside = foldInside$1;
...
//# sourceMappingURL=stencila-editor-58b613dd.js.map