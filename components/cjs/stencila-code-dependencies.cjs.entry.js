...
const CodeDependencies = class {
  ...
  render() {
    var _a, _b, _c, _d, _e;
    return (index.h(index.Host, null, ((_b = (_a = this.el) === null || _a === void 0 ? void 0 : _a.children.length) !== null && _b !== void 0 ? _b : 0) > 0 &&
      (((_c = this.el) === null || _c === void 0 ? void 0 : _c.slot) === 'code-dependencies' ? (index.h("stencila-menu-item", { divider: true }, "Upstream dependencies")) : ((_d = this.el) === null || _d === void 0 ? void 0 : _d.slot) === 'code-dependents' ? (index.h("stencila-menu-item", { divider: true }, "Downstream dependents")) : null), ((_e = this.el) === null || _e === void 0 ? void 0 : _e.querySelectorAll('stencila-code-dependency').length) == 0 ? (index.h("div", { class: "none" }, "None")) : null, index.h("slot", null)));
  }
...
exports.stencila_code_dependencies = CodeDependencies;

//# sourceMappingURL=stencila-code-dependencies.cjs.entry.js.map