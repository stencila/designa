...
const BooleanValidator = ({ valueEl, }) => {
  ...
  return (index.h(index.Fragment, null,
    index.h("label", null,
      "Default value",
      index.h("input", { type: "checkbox", name: "default", checked: values.default === 'true' }))));
};
...
const IntegerValidator = ({ valueEl, }) => {
  ...
  return (index.h(index.Fragment, null,
    index.h("label", null,
      "Default value",
      index.h("input", { type: "number", name: "default", step: "1", value: values.default })),
    index.h("label", null,
      "Minimum",
      index.h("input", { type: "number", name: "minimum", step: "1", value: values.minimum })),
    index.h("label", null,
      "Maximum",
      index.h("input", { type: "number", name: "maximum", step: "1", value: values.maximum }))));
};
...
const NumberValidator = ({ valueEl, }) => {
  ...
  return (index.h(index.Fragment, null,
    index.h("label", null,
      "Default value",
      index.h("input", { type: "number", name: "default", step: "any", value: values.default })),
    index.h("label", null,
      "Minimum",
      index.h("input", { type: "number", name: "minimum", step: "any", value: values.minimum })),
    index.h("label", null,
      "Maximum",
      index.h("input", { type: "number", name: "maximum", step: "any", value: values.maximum }))));
};
...
const StringValidator = ({ valueEl, }) => {
  ...
  return (index.h(index.Fragment, null,
    index.h("label", null,
      "Default value",
      index.h("input", { type: "text", name: "default", value: values.default })),
    index.h("label", null,
      "Minimum length",
      index.h("input", { type: "number", step: "1", name: "minLength", value: values.minLength, min: "0" })),
    index.h("label", null,
      "Maximum length",
      index.h("input", { type: "number", step: "1", name: "maxLength", value: values.maxLength })),
    index.h("label", null,
      "Pattern (RegEx)",
      index.h("input", { type: "text", name: "pattern", value: values.pattern }))));
};
...
const getValidator = (valueElRef) => (validatorType) => {
  switch (validatorType) {
    case 'NumberValidator': {
      return index.h(NumberValidator, { valueEl: valueElRef });
    }
    case 'IntegerValidator': {
      return index.h(IntegerValidator, { valueEl: valueElRef });
    }
    case 'StringValidator': {
      return index.h(StringValidator, { valueEl: valueElRef });
    }
    case 'ConstantValidator': {
      return index.h(ConstantValidator, { valueEl: valueElRef });
    }
    case 'BooleanValidator': {
      return index.h(BooleanValidator, { valueEl: valueElRef });
    }
  }
};
const Validator = (props) => {
  return (index.h("stencila-menu", { autoClose: false, menuPosition: "bottom-start" },
    index.h("stencila-button", { iconOnly: true, icon: "equalizer", size: "xsmall", slot: "toggle", "aria-label": "Toggle menu", color: "key", minimal: true }),
    index.h("form", { onChange: props.onValidatorChange, onInput: validateField, onFocusin: validateField },
      index.h("label", null,
        "Type",
        index.h("select", { name: "validator" },
          index.h("option", { disabled: true, selected: props.type === undefined }, "Select\u2026"),
          index.h("option", { value: "BooleanValidator", selected: props.type === 'BooleanValidator' }, "Boolean"),
          index.h("option", { value: "IntegerValidator", selected: props.type === 'IntegerValidator' }, "Integer"),
          index.h("option", { value: "NumberValidator", selected: props.type === 'NumberValidator' }, "Number"),
          index.h("option", { value: "StringValidator", selected: props.type === 'StringValidator' }, "String"),
          index.h("option", { value: "EnumValidator", selected: props.type === 'EnumValidator' }, "Enum"))),
...
const Parameter = class {
  constructor(hostRef) {
    ...
    this.parameterChange = index.createEvent(this, "stencila-parameter-change", 7);
    this.validatorChange = index.createEvent(this, "stencila-validator-change", 7);
  ...
  componentWillLoad() {
    ...
    this.labelSlotRef = slotSelectors.getSlotByName(this.el)('name')[0];
    const valueEl = slotSelectors.getSlotByName(this.el)('value');
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("span", { class: "actions" }, this.mode === 'edit' && (index.h(Validator, { type: this.validator, onValidatorChange: this.onValidatorChange, valueElRef: this.valueSlotRef })), index.h("span", { class: "name", contentEditable: this.mode === 'edit', onClick: (e) => {
        if (this.mode === 'edit') {
          e.preventDefault();
        }
      }, onInput: this.onParamNameChange, ref: (el) => (this.labelSlotRef = el) }, index.h("slot", { name: "name" }))), index.h("form", { class: "value", title: labelText }, index.h("slot", { name: "value" }))));
  }
...
exports.stencila_parameter = Parameter;

//# sourceMappingURL=stencila-parameter.cjs.entry.js.map