...
export class Input {
  ...
  render() {
    ...
    return (h(Host, { class: { inline: this.inline } },
      ...
      h("input", Object.assign({}, _type, _label, { 
  ...
  static get properties() { return {
    ...
    "type": {
      ...
      "mutable": false,
      "complexType": {
        "original": "'text' | 'password' | 'number' | 'file' | 'search'",
        "resolved": "\"file\" | \"number\" | \"password\" | \"search\" | \"text\"",
        "references": {}
      },
      "required": false,
      "optional": false,
    ...
    "readOnly": {
      ...
      "docs": {
        "tags": [],
        "text": "Indicate that this is a controlled input, preventing user editing of the value"
      },
      "attribute": "read-only",
      "reflect": false,
      "defaultValue": "false"
