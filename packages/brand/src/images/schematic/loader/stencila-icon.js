;(function(lib, img, cjs, ss) {
  ...
  ;(lib.stencil = function(mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'AkfEgIAAo/II/AAIAAI/gAhshsQgtAtAAA/QAAA/AtAuQAuAtA+AAQBAAAAtgtQAtguAAg/QAAg+gtguQgtgthAAAQg+AAguAtg'
      )
  ...
  ;(lib.dot2 = function(mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'AhsBtQgtguAAg/QAAg+AtguQAugtA+AAQA/AAAuAtQAtAtAAA/QAAA/gtAuQguAtg/AAQg/AAgtgtg'
      )
